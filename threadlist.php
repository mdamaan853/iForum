...
// echo var_dump($thread_user_id);
    ...
    //   echo $row2['user_name'];
      ...
      <p class="featurette-heading font-weight-bold "> '. $row2['user_name'] .'  at '. $thread_time   .'</p>
      <h5 class="mt-0 my-1"> <a href="thread.php?threadid='. $thread_id .'&&catid='. $id .'" class="text-dark">'. $thread_title .'</a></h5>
      '. $thread_desc .'
    </div>
</div>';
}
